# app/main_interface_v2.py
# Versión 2 con parámetros avanzados de K-Means y clustering
...
st.set_page_config(
    page_title='📚 Pipeline de Procesamiento de Videos (v2)',
    layout='wide',
)
...
st.sidebar.title('🎬 Pipeline de Videos (v2)')
st.sidebar.info('✨ Proyecto vision asiistida por computador')
...
###################################################
# Sección 4: Selección de keyframes (VERSIÓN CON PARÁMETROS AVANZADOS)
###################################################
elif modo == '4️⃣ Selección de Keyframes':
    st.title('4️⃣ Selección de Keyframes')
    st.info('✨ Versión 2: Con parámetros avanzados de K-Means y clustering')
    ...
    # Configuración de Selección de Keyframes (aplica a ambos métodos)
